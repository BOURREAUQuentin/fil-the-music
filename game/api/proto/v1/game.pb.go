...
const file_api_proto_v1_game_proto_rawDesc = "" +
	...
	"\x14correct_answer_index\x18\x04 \x01(\x05R\x12correctAnswerIndex2\x8d\x04\n" +
	"\vGameService\x12E\n" +
	"\n" +
	...
	"\x0fAnswerQuestions\x12\x1f.user.v1.AnswerQuestionsRequest\x1a .user.v1.AnswerQuestionsResponseB.Z,github.com/BOURREAUQuentin/game/api/proto/v1b\x06proto3"
...
var file_api_proto_v1_game_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_api_proto_v1_game_proto_goTypes = []any{
	...
	(*AnswerQuestionsRequest)(nil),  // 2: user.v1.AnswerQuestionsRequest
	(*AnswerQuestionsResponse)(nil), // 3: user.v1.AnswerQuestionsResponse
	(*QuestionResult)(nil),          // 4: user.v1.QuestionResult
	(*GetActiveQuizRequest)(nil),    // 5: user.v1.GetActiveQuizRequest
	(*GetActiveQuizResponse)(nil),   // 6: user.v1.GetActiveQuizResponse
	(*CreateQuizRequest)(nil),       // 7: user.v1.CreateQuizRequest
	(*CreateQuizResponse)(nil),      // 8: user.v1.CreateQuizResponse
	(*GetSessionsRequest)(nil),      // 9: user.v1.GetSessionsRequest
	(*GetSessionsResponse)(nil),     // 10: user.v1.GetSessionsResponse
	(*JoinQuizRequest)(nil),         // 11: user.v1.JoinQuizRequest
	(*JoinQuizResponse)(nil),        // 12: user.v1.JoinQuizResponse
	(*QuitQuizRequest)(nil),         // 13: user.v1.QuitQuizRequest
	(*QuitQuizResponse)(nil),        // 14: user.v1.QuitQuizResponse
	(*Session)(nil),                 // 15: user.v1.Session
	(*Quiz)(nil),                    // 16: user.v1.Quiz
	(*Question)(nil),                // 17: user.v1.Question
	(*timestamppb.Timestamp)(nil),   // 18: google.protobuf.Timestamp
}
var file_api_proto_v1_game_proto_depIdxs = []int32{
	16, // 0: user.v1.GetQuizzesResponse.quizzes:type_name -> user.v1.Quiz
	4,  // 1: user.v1.AnswerQuestionsResponse.results:type_name -> user.v1.QuestionResult
	16, // 2: user.v1.GetActiveQuizResponse.quiz:type_name -> user.v1.Quiz
	17, // 3: user.v1.CreateQuizRequest.questions:type_name -> user.v1.Question
	16, // 4: user.v1.CreateQuizResponse.quiz:type_name -> user.v1.Quiz
	15, // 5: user.v1.GetSessionsResponse.sessions:type_name -> user.v1.Session
	15, // 6: user.v1.JoinQuizResponse.session:type_name -> user.v1.Session
	18, // 7: user.v1.Session.joined_at:type_name -> google.protobuf.Timestamp
	18, // 8: user.v1.Session.last_activity:type_name -> google.protobuf.Timestamp
	18, // 9: user.v1.Quiz.created_at:type_name -> google.protobuf.Timestamp
	17, // 10: user.v1.Quiz.questions:type_name -> user.v1.Question
	0,  // 11: user.v1.GameService.GetQuizzes:input_type -> user.v1.GetQuizzesRequest
	9,  // 12: user.v1.GameService.GetSessions:input_type -> user.v1.GetSessionsRequest
	11, // 13: user.v1.GameService.JoinQuiz:input_type -> user.v1.JoinQuizRequest
	13, // 14: user.v1.GameService.QuitQuiz:input_type -> user.v1.QuitQuizRequest
	7,  // 15: user.v1.GameService.CreateQuiz:input_type -> user.v1.CreateQuizRequest
	5,  // 16: user.v1.GameService.GetActiveQuiz:input_type -> user.v1.GetActiveQuizRequest
	2,  // 17: user.v1.GameService.AnswerQuestions:input_type -> user.v1.AnswerQuestionsRequest
	1,  // 18: user.v1.GameService.GetQuizzes:output_type -> user.v1.GetQuizzesResponse
	10, // 19: user.v1.GameService.GetSessions:output_type -> user.v1.GetSessionsResponse
	12, // 20: user.v1.GameService.JoinQuiz:output_type -> user.v1.JoinQuizResponse
	14, // 21: user.v1.GameService.QuitQuiz:output_type -> user.v1.QuitQuizResponse
	8,  // 22: user.v1.GameService.CreateQuiz:output_type -> user.v1.CreateQuizResponse
	6,  // 23: user.v1.GameService.GetActiveQuiz:output_type -> user.v1.GetActiveQuizResponse
	3,  // 24: user.v1.GameService.AnswerQuestions:output_type -> user.v1.AnswerQuestionsResponse
